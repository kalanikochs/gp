...
@Component({
  selector: 'app-configurar-grupo-muscular',
  templateUrl: './configurar-grupo-muscular.component.html',
  styleUrls: ['./configurar-grupo-muscular.component.scss']
})
export class ConfigurarGrupoMuscularComponent implements OnInit {
