...
@Component({
  selector: 'app-modificar-psicologia-dialog',
  templateUrl: './modificar-psicologia-dialog.component.html',
  styleUrls: ['./modificar-psicologia-dialog.component.scss']
})
export class ModificarPsicologiaDialogComponent implements OnInit {
  estados = [
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<ModificarPsicologiaDialogComponent>,
  ...
  modificarAlimento(){
    if (this.modificarAlimentoForm.valid) {
      ...
      const url = `${environment.apiUrl}/shared/rutinas/modificarIndicaciones/`;
