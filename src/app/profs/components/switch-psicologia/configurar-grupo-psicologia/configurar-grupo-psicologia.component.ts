...
@Component({
  selector: 'app-configurar-grupo-psicologia',
  templateUrl: './configurar-grupo-psicologia.component.html',
  styleUrls: ['./configurar-grupo-psicologia.component.scss']
})
export class ConfigurarGrupoPsicologiaComponent implements OnInit {
  ...
  agregarEjercicio() {
    if (this.asignarEjercicio.valid) {
      const data = new FormData();
      data.append('terapia', this.asignarEjercicio.value.ejercicio);

      const url = `${environment.apiUrl}/shared/rutinas/agregarTerapia/`;
